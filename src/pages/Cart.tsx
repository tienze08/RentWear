...
const Cart = () => {
    ...
    const totalPrice = selectedRentals.reduce(
                ...
                {rentals.length > 0 ? (
                                            ...
                                            >
                                                <div className="flex sm:items-center w-full">
                                                    <label className="flex items-center gap-3 w-full cursor-pointer">
                                                        <input
                                                            type="checkbox"
                                                            checked={selectedRentalIds.includes(
                                                                rental._id
                                                            )}
                                                            onChange={() =>
                        ...
                        <div className="lg:w-1/3">
                            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
                                ...
                                <p className="text-fashion-muted text-sm text-center mt-4">
                                    By checking out, you agree to our Terms of
                    ...
                    <div className="text-center py-16 bg-white rounded-lg shadow-md">
                        ...
                        <p className="text-fashion-muted mb-8">
                            Explore our collection and add items to your cart to
                            get started.
                        </p>
                        <Link
                            to="/products"
